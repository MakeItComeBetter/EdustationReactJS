...
const Community = ({
  ...
  const addFriend = (targetUser) => {
    
    createNewNotification(currentUser, targetUser?.uid, {
      title: "Add Friend",
      message: `You having request friend from ${currentUser?.displayName}`,
      useActions: true,
      typeAction: "ADD_FRIEND",
    })
  };
  ...
  return (
    <Grid container>
      <HeaderSection
        title="Community"
        link={MESSENGER_PATH}
        iconAction={<FontAwesomeIcon icon={faSearch} />}
      />
              ...
              <div
                ...
                style={{
                  backgroundImage: `url(${
                    v.photoURL
                      ? v?.photoURL
                      : "https://i.pinimg.com/originals/9d/ba/20/9dba20a19c514660b135f1dd831102e2.jpg"
                  })`,
                }}
              >
                ...
                <div className="community__widget_in4">
                  <span>
                    {v?.displayName === currentUser.displayName
                      ? "You"
                      : v?.displayName}
                  </span>
                </div>
